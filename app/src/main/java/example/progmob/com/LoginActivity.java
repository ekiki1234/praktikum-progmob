...
public class LoginActivity extends AppCompatActivity {
    ...
    private String url_insert_token = Server.URL + "insertToken.php";
...
//                startActivity(intent);
    ...
    private void input_token(final String idx){

        StringRequest strReq = new StringRequest(Request.Method.POST, url_insert_token, new Response.Listener<String>() {
